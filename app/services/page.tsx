...
export default function ServicesPage() {
  return <PageFrame>
    <PageHero eyebrow="Services" title="Residential work, defined clearly."><p>These evidence-supported service categories are ready for owner review. Project scope, availability and service location are confirmed during the initial conversation.</p><OwnerTag>Every service requires owner confirmation.</OwnerTag></PageHero>
